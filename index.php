...
<div class="wrap">
    ...
    <section class="intro">
        <div class="intro_title">
            <h2>The 200 Archive charts the past, present and future of Irish design by publishing 100 notable communication design projects, selected each year following an&nbsp;open&nbsp;call.</h2>
        </div>
